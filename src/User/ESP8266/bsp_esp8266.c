...
volatile uint8_t ucTcpClosedFlag = 0; // 0 means connection ; otherwise means connection loss
...
bool ESP8266_SetupConnection( void ) {
  ...
  printf ( "\r\n正在配置 ESP8266 ......\r\n" );
	...
	printf("set bit success\r\n");
	ESP8266_AT_Test ();
	printf("AT test pass\r\n");
	rst = ESP8266_Net_Mode_Choose ( STA );
	printf("Net mode choose %d\r\n", rst);
	//ESP8266_ListAp();
  while ( ! ESP8266_JoinAP ( macUser_ESP8266_ApSsid, macUser_ESP8266_ApPwd ) );	
	printf("Net connection success\r\n");
