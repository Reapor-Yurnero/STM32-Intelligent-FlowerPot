...
// DATA2 PB.10-> PA.6
// DATA3 PB.11-> PA.7
#define      OV7725_DATA_GPIO_CLK1                    RCC_APB2Periph_GPIOA
#define      OV7725_DATA_GPIO_PORT1                   GPIOA
#define      OV7725_DATA_0_GPIO_PIN                   GPIO_Pin_4
#define      OV7725_DATA_1_GPIO_PIN                   GPIO_Pin_5
#define      OV7725_DATA_2_GPIO_PIN                   GPIO_Pin_6
#define      OV7725_DATA_3_GPIO_PIN                   GPIO_Pin_7
...
#define READ_FIFO_PIXEL(RGB565)   	do{\
	                                  RGB565=0;\
	                                  FIFO_RCLK_L();\
	                                  RGB565 = ((OV7725_DATA_GPIO_PORT->IDR) & 0xf000 ) | ((OV7725_DATA_GPIO_PORT1->IDR << 4) & 0x0f00);\
	                                  FIFO_RCLK_H();\
                                    FIFO_RCLK_L();\
	                                  RGB565 |= ((OV7725_DATA_GPIO_PORT->IDR >>8) & 0x00f0) | ((OV7725_DATA_GPIO_PORT1->IDR >> 4) & 0x000f);\
	                                  FIFO_RCLK_H();\
                                    }while(0)
